...
export default function App() {
  ...
  const isPitchHalf = pitchMode === 'half';
  const isBasketball = sport === 'basketball';
  const isFootball = sport === 'football';
  ...
  const getPitchContainerStyles = () => {
    ...
    if (isPitchHalf) {
      if (sport === 'basketball') {
        ...
        return isHorizontal 
          ? { aspectRatio: '0.93', height: '100%', maxHeight: '850px' } 
          : { aspectRatio: '1.07', width: '100%', maxWidth: '1300px' };
      }
      ...
      return isHorizontal 
        ? { aspectRatio: '0.77', height: '100%', maxHeight: '850px' } 
        : { aspectRatio: '1.29', width: '100%', maxWidth: '1300px' };
    }
    ...
    if (sport === 'basketball') {
       ...
       // Horizontal: ~1.88
       return isHorizontal
        ? { aspectRatio: '1.88', width: '100%', maxWidth: '1300px' }
        : { aspectRatio: '0.53', height: '100%', maxHeight: '850px' };
    }

    // Default Full Ratios (Football/Volleyball)
    return isHorizontal
      ? { aspectRatio: '1.54', width: '100%', maxWidth: '1300px' }
      : { aspectRatio: '0.65', height: '100%', maxHeight: '850px' };
  };
                    ...
                    <div className="grid grid-cols-2 gap-1.5">
                      {[
                        ...
                        <button
                          ...
                          className={`py-2 px-1 rounded text-[9px] font-black uppercase border transition-all ${
                            pitchMode === m.id 
                    ...
                    <div className="pt-2 border-t border-line/40">
                      ...
                      <div className="flex gap-2 p-1 bg-panel-strong/30 rounded-lg border border-line">
                        <button 
                          ...
                          className={`flex-1 py-1.5 rounded text-[9px] font-black uppercase border transition-all ${
                            attackingTeam === 'home' 
                              ? 'bg-accent/10 border-accent text-accent' 
                              : 'bg-panel-strong/40 border-line text-ink/60 hover:border-accent/40'
                          }`}
          ...
          >
            {/* The Pitch Rendering */}
              <div 
                ...
                className={`relative shadow-[0_30px_90px_-20px_rgba(0,0,0,0.5)] overflow-hidden border-[4px] border-white/95 rounded-sm transition-all duration-500 ease-in-out ${
